...
Characteristics of RL probelms: 1) No supervision, only (occasional) rewards as feedback 2) sequential decision making. Data is generated as sequences, not i.i.d 3) Training data is generated by the learner's own behavior<br/><br/>
...
When should we worry about sequential decision making: 1) limited supervision: you know what you want, but not how to get it 2) actions have consequences<br/><br/>
