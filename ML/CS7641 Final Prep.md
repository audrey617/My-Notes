...
<p align="center" width="100%">
    <img width="50%" src="https://github.com/audrey617/Notes/blob/main/ML/images/ul2.JPG?raw=true">
</p>

𝑘-means in Euclidean space:<br/>
<p align="center" width="100%">
    <img width="50%" src="https://github.com/audrey617/Notes/blob/main/ML/images/ul1.JPG?raw=true">
</p>
breaking tie consistently (give a rule) is going to guarantee that we are at least don't spin around without improving.
...
• Works with any distribution (if 𝐸 and 𝜇 are solvable).
...
K Means VS Expectation Maximization: <br/>
K-Means: <br/>
Assigned each example to exactly one cluster<br/>
Hard to tell which cluster is right when there is overlapping ( suggests uncertainty )<br/>
Uses Euclidean Distance<br/>
faces difficulty when clusters are non circular<br/>

Gaussian Mixture Models:<br/>
Clusters modeled as gaussians ( not just by their means, but also the covariance )<br/>
EM Algorithm: Assigns data to the cluster with some probability<br/>
Gives probability of x! (ie it's generative )<br/>
